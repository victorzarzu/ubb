...
void apply_conv_cols(const int& start_col, const int& end_col, const int& n_mat, const int& m_mat, const int& n_conv, const int& m_conv, int mat[][10001], int conv_mat[][6], int result[][10001]) {
