    ...
    public class Ellipsoid : Geometry
    {
        ...
        public override Intersection GetIntersection(Line line, double minDist, double maxDist)
        {
            ...
            if(t1 > 0) {
                ...
                return new Intersection(true, true, this, line, t1, Normal(X), this.Material, this.Color);
            }
            if(t2 > 0) {
                var X = line.X0 + line.Dx * t2;
                return new Intersection(true, true, this, line, t2, Normal(X), this.Material, this.Color);
            }
            return Intersection.NONE;
        }
    }
