...
DELETE Piese;
DELETE LiniiAsamblare;
DELETE Proprietati;
DELETE ProprietatiPiese;
DELETE Produse;
DELETE PieseProduse;
DELETE Furnizori;
DELETE Facturi;
DELETE Materiale;
DELETE MaterialeFacturi;
DELETE MaterialePiese;
GO
...
INSERT INTO Proprietati(Nume, UnitateMasura) VALUES('Temperatura functionare', 'C');
