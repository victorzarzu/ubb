...
private:
	...
	*/
	DynamicArray<Masina> generalSort(function<bool(const Masina& m1, const Masina& m2)> rel);
	...
	*/
	DynamicArray<Masina> generalFilter(function<bool(const Masina& m)> filter);
...
public:
	...
	*/
	DynamicArray<Masina> filterByProducator(string producator);
	...
	*/
	DynamicArray<Masina> filterByTip(string tip);
